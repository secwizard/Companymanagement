...
namespace CompanyManagement.Api.Controllers
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        [HttpPost("GetAllSocialDetails")]
        public async Task<IActionResult> GetAllSocialDetails(SocialReqById request)
        {
            Response<CompanySocialLinkResponse> returnVal = new Response<CompanySocialLinkResponse>();

            try
            {
                var result = await _companyService.GetAllSocialDetails(request);
        ...
        [HttpPost("GetSocialLinkById")]
        public async Task<IActionResult> GetSocialLinkById(SocialReqById request)
        {
            Response<CompanySocialLink> returnVal = new Response<CompanySocialLink>();
            try
            {
                var result = await _companyService.GetSocialLinkById(request);
                returnVal.Data = result;
                returnVal.Status = result != null;
                returnVal.Message = result == null ? "Data Not Found" : string.Empty;
