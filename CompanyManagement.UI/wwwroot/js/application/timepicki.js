		...
		return this.each(function() {
			...
			var new_ele = $(
				"<div class='timepicker_wrap " + settings.custom_classes + "'>" +
					...
					"<div class='time'>" +
						top_arrow_button +
						"<div class='ti_tx'><input type='text' id='txtHour' class='timepicki-input'" + (settings.disable_keyboard_mobile) + "></div>" +
						bottom_arrow_button +
					"</div>" +
					"<div class='mins'>" +
						top_arrow_button +
						"<div class='mi_tx'><input type='text' id='txtMinute' class='timepicki-input'" + (settings.disable_keyboard_mobile) + "></div>" +
						bottom_arrow_button +
					"</div>");
			if(settings.show_meridian){
				new_ele.append(
			...
			inputs.on('blur', function () {
			    ...
			    if (Hour > 12) {
			        document.getElementById('txtHour').value = '00';
			    }
			    if (Minute > 59) {
